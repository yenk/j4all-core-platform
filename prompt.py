...
def run_chatbot():
    ...
    gr.ChatInterface(
        ...
        title="Hi, I'm LumiLens! I'm an AI-powered tool designed to assist with Justice for All ontract law and appellate matters. I'm a prototype, and my owner is working to bring me to life!",
